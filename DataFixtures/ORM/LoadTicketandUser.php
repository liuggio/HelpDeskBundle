...
class LoadTicket extends AbstractFixture implements OrderedFixtureInterface, ContainerAwareInterface
{
    private $container;
    ...
    public function load(\Doctrine\Common\Persistence\ObjectManager $em)
    {
        ...
        $user3->addGroup( $em->merge($this->getReference("group_customer")) );
        $em->persist($user3);
        ...
        $user4->addGroup( $em->merge($this->getReference("group_customer")) );
        $em->persist($user4);
